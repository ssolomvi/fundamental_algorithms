...
#pragma region template methods
    ...
    protected:
        ...
        {
            this->trace_with_guard("b_tree_incorrect::template_method_basics::insert_key_in_nonfull_node method started");
...
//                current_node->_values[0] = std::move(value);
                ...
                this->trace_with_guard("b_tree_incorrect::template_method_basics::insert_key_in_nonfull_node method finished");
                return 0;
            }
            ...
            if (comparison_result == 0) {
                this->warning_with_guard("b_tree_incorrect::template_method_basics::insert_key_in_nonfull_node key is not unique")
                    ->trace_with_guard("b_tree_incorrect::template_method_basics::insert_key_in_nonfull_node method finished");
                throw insert_exception("b_tree_incorrect::template_method_basics::insert_key_in_nonfull_node key is not unique");
            }
            ...
            while (true)
            {
                ...
                while (low <= high) {
                    ...
                    if (mid != (*iterator)->_number_of_keys) {
                        if (comparison_result == 0) {
                            this->debug_with_guard("b_tree_incorrect::template_methods::basics::find_path current node count: " +
...
#pragma region insertion template method
    ...
    public:
        ...
        {
            this->trace_with_guard("b_tree_incorrect::insertion_template_method::split method started");
            ...
            this->trace_with_guard("b_tree_incorrect::insertion_template_method::split method finished");
...
//                this->insert_key_in_nonfull_node(*current_node, key, std::move(value));
            ...
            while (((*current_node) != nullptr) || (*current_node)->_number_of_keys == max_number_of_keys_in_node) {
                ...
                auto comparison_result = comparer(key, (*current_node)->_keys[closest_index]);
                if (comparison_result == 0) {
                    throw insert_exception("b_tree_incorrect::insertion_template_method::insert::insert_key_in_nonfull_node key is not unique");
                }
            ...
            this->trace_with_guard("b_tree_incorrect::insertion_template_method::insert method finished");
        }
...
#pragma region finding template method
    ...
    public:
        ...
        {
            this->trace_with_guard("b_tree_incorrect::finding_template_method::find method started");
            if (this->get_root_node() == nullptr) {
                this->information_with_guard("b_tree_incorrect::finding_template_method::find the tree is empty")
                    ->trace_with_guard("b_tree_incorrect::finding_template_method::find method finished");
            }
            ...
            {
                this->debug_with_guard("b_tree_incorrect::finding_template_method::find no value with passed key in tree")
                    ->trace_with_guard("b_tree_incorrect::finding_template_method::find method finished");
                throw find_exception("b_tree_incorrect::finding_template_method::find no value with passed key in tree");
            }

            this->trace_with_guard("b_tree_incorrect::finding_template_method::find method finished");
...
#pragma region removing template method
    ...
    public:
        ...
        {
            this->trace_with_guard("b_tree_incorrect::removing_template_method::remove_inner method started")
            ...
            unsigned min_count_of_keys_in_node = this->_target_tree->_tree_parameter - 1;
            if ((*current_node)->_is_leaf) {
                this->debug_with_guard("b_tree_incorrect::removing_template_method::remove_inner removing from a leaf");
            ...
            {
                this->debug_with_guard("b_tree_incorrect::removing_template_method::remove_inner removing from an inner node");
                // find sub nodes
                ...
                if (suitable_node != nullptr) {
                    this->debug_with_guard("b_tree_incorrect::removing_template_method::remove_inner there is a sub-node with count: " +
                    ...
                    // merge sub nodes
                    this->debug_with_guard("b_tree_incorrect::removing_template_method::remove_inner there are no sub trees with count > " +
                    ...
                    if ((*current_node)->_number_of_keys == 1) {
                        ...
                        this->debug_with_guard("b_tree_incorrect::removing_template_method::remove_inner replace current node with left subtree node");
...
//                        node * tmp = (*current_node);
             ...
             */
            this->trace_with_guard("b_tree_incorrect::removing_template_method::remove_inner method finished");
        }
        ...
        virtual tvalue remove(tkey const &key)
        {
            ...
            if (comparison_result != 0)
            {
                this->warning_with_guard("b_tree_incorrect::removing_template_method::remove passed key is not found")
                    ->trace_with_guard("b_tree_incorrect::removing_template_method::remove method finished");
                throw remove_exception("b_tree_incorrect::removing_template_method::remove passed key is not found");
            }
            ...
            this->trace_with_guard("b_tree_incorrect::removing_template_method::remove method finished");
            return result;
        }
...
public:
    ...
    {
        if (tree_parameter < 2) {
            throw b_tree_exception("b_tree_incorrect::tree parameter cannot be less than 3");
        }
    }
